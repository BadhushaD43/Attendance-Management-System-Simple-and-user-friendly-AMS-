      ...
      <div className="table-card">
        <div className="table-card-header">
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            <button className="btn-add" onClick={openAddDialog}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: 8 }}>
                      <button
                        ...
                        title="Edit Employee"
                        style={{ background: 'none', border: 'none', color: '#1e5799', cursor: 'pointer', padding: 4 }}
                      >
                        <MdEdit size={18} />
                      </button>
                      <button
                        ...
                        style={{ background: 'none', border: 'none', color: '#e74c3c', cursor: 'pointer', padding: 4 }}
                      >
                        <MdDelete size={18} />
                      </button>
                    </div>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className="modal-body">
              ...
              <div className="form-group">
                <label>Employee Name <span style={{ color: '#e74c3c' }}>*</span></label>
                <input
                  type="text"
              ...
              {/* Email */}
              <div className="form-group">
                <label>Employee Email<span style={{ color: '#e74c3c' }}>*</span></label>
                <input
                  type="email"
              ...
              {/* Department */}
              <div className="form-group">
                <label>Department <span style={{ color: '#e74c3c' }}>*</span></label>
                <select
